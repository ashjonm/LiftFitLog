...
const localEntries = [
    ...
    {dayId:2, ...baseCalisthenics, id:8, name:"pullups", reps:10, extra:-15},
    {dayId:2, ...baseActivity, id:9},
    {dayId:2, ...baseWeightTraining, id:10, name:"Bench Press", weight:140, count:4},
    {dayId:3, ...baseWeightTraining, id:11, },
    {dayId:3, ...baseCalisthenics, id:12},
    {dayId:3, ...baseCalisthenics, id:13, name:"pullups", reps:10, extra:-15},
    {dayId:3, ...baseDistanceExcercise, id:14},
    {dayId:3, ...baseActivity, id:15},
    ...
    {dayId:4, ...baseCalisthenics, id:19, name:"pullups", reps:10, extra:-15},
    {dayId:4, ...baseDistanceExcercise, id:20},
    {dayId:4, ...baseActivity, id:21},
    {dayId:4, ...baseWeightTraining, id:22, name:"Bench Press", weight:140, count:4},
];